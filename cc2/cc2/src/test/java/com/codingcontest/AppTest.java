...
public class AppTest 
{
    ...
    public void setup() throws IOException
    {
        ...
        ExtentSparkReporter spark = new ExtentSparkReporter("D:\\Testing\\cc2\\src\\report\\report.html");
        extentReports.attachReporter(spark);
        spark.config().setDocumentTitle("Report Title");
        spark.config().setTheme(Theme.DARK);

        workbook = new XSSFWorkbook("C:\\Users\\91852\\Downloads\\cc2\\cc2\\src\\Excel\\information.xlsx");
    ...
    public void testCase3() throws InterruptedException
    {
        ...
        driver.findElement(By.xpath("//*[@id='onetrust-close-btn-container']/button")).click();        Thread.sleep(2000);
